...
public class TransactionResult {
     ...
     */
    protected List<AnticInternalTransaction> internalTransactions;
    ...
    public List<AnticInternalTransaction> getInternalTransactions() {
        return internalTransactions;
    }

    public void setInternalTransactions(List<AnticInternalTransaction> internalTransactions) {
        this.internalTransactions = internalTransactions;
    }

    public void addInternalTransaction(AnticInternalTransaction internalTransaction) {
    ...
    public static TransactionResult fromBytes(byte[] bytes) {
        ...
        if (dec.getReadIndex() != bytes.length) {
            ...
            List<AnticInternalTransaction> internalTransactions = new ArrayList<>();
            n = dec.readInt();
            for (int i = 0; i < n; i++) {
                internalTransactions.add(AnticInternalTransaction.fromBytes(dec.readBytes()));
            }
    ...
    public byte[] toBytes() {
        ...
        for (AnticInternalTransaction tx : internalTransactions) {
