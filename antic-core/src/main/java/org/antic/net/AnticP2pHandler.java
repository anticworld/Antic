...
import static org.antic.net.msg.p2p.NodesMessage.MAX_NODES;
...
import org.antic.core.BftManager;
import org.antic.core.Block;
import org.antic.core.BlockHeader;
import org.antic.core.BlockPart;
import org.antic.core.Blockchain;
import org.antic.core.PendingManager;
import org.antic.core.SyncManager;
import org.antic.net.NodeManager.Node;
import org.antic.net.msg.Message;
import org.antic.net.msg.MessageQueue;
import org.antic.net.msg.ReasonCode;
import org.antic.net.msg.consensus.BlockHeaderMessage;
import org.antic.net.msg.consensus.BlockMessage;
import org.antic.net.msg.consensus.BlockPartsMessage;
import org.antic.net.msg.consensus.GetBlockHeaderMessage;
import org.antic.net.msg.consensus.GetBlockMessage;
import org.antic.net.msg.consensus.GetBlockPartsMessage;
import org.antic.net.msg.consensus.NewHeightMessage;
import org.antic.net.msg.p2p.DisconnectMessage;
import org.antic.net.msg.p2p.GetNodesMessage;
import org.antic.net.msg.p2p.NodesMessage;
import org.antic.net.msg.p2p.PingMessage;
import org.antic.net.msg.p2p.PongMessage;
import org.antic.net.msg.p2p.TransactionMessage;
import org.antic.net.msg.p2p.handshake.v2.HelloMessage;
import org.antic.net.msg.p2p.handshake.v2.InitMessage;
import org.antic.net.msg.p2p.handshake.v2.WorldMessage;
...
/**
 * Antic P2P message handler
 */
public class AnticP2pHandler extends SimpleChannelInboundHandler<Message> {

    private final static Logger logger = LoggerFactory.getLogger(AnticP2pHandler.class);
     ...
     * @param channel
     */
    public AnticP2pHandler(Channel channel, Kernel kernel) {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        if (useNewHandShake) {
            ...
            if (channel.isOutbound()) {
                Message helloMessage = new org.antic.net.msg.p2p.handshake.v1.HelloMessage(
    ...
    public void channelRead0(final ChannelHandlerContext ctx, Message msg) throws InterruptedException {
        ...
        case HELLO:
            if (!useNewHandShake)
                onHello((org.antic.net.msg.p2p.handshake.v1.HelloMessage) msg);
            break;
        case WORLD:
            if (!useNewHandShake)
                onWorld((org.antic.net.msg.p2p.handshake.v1.WorldMessage) msg);
            break;
        case PING:
            onPing();
            break;
    ...
    protected void onHello(org.antic.net.msg.p2p.handshake.v1.HelloMessage msg) {
        ...
        msgQueue.sendMessage(new org.antic.net.msg.p2p.handshake.v1.WorldMessage(
                config.network(), config.networkVersion(), client.getPeerId(),
                client.getIp(), client.getPort(),
                config.getClientId(),
                chain.getLatestBlockNumber(),
    ...
    protected void onWorld(org.antic.net.msg.p2p.handshake.v1.WorldMessage msg) {
        Peer peer = msg.getPeer();
