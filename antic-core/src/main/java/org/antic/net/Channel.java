...
public class Channel {
    ...
    public void init(ChannelPipeline pipe, boolean isInbound, InetSocketAddress remoteAddress, Kernel kernel) {
        ...
        pipe.addLast("frameHandler", new AnticFrameHandler(kernel.getConfig()));
        pipe.addLast("messageHandler", new AnticMessageHandler(kernel.getConfig()));
        pipe.addLast("p2pHandler", new AnticP2pHandler(this, kernel));
    }
