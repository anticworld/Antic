...
public class AnticChannelInitializer extends ChannelInitializer<NioSocketChannel> {

    private static final Logger logger = LoggerFactory.getLogger(AnticChannelInitializer.class);
    ...
    /**
     * Create an instance of AnticChannelInitializer.
     * 
     * @param kernel
     *            the kernel instance
     * @param remoteNode
     ...
     */
    public AnticChannelInitializer(Kernel kernel, Node remoteNode, boolean discoveryMode) {
        this.kernel = kernel;
    ...
    public AnticChannelInitializer(Kernel kernel, Node remoteNode) {
