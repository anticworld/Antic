...
public class AnticFrameHandler extends ByteToMessageCodec<Frame> {

    private static final Logger logger = LoggerFactory.getLogger(AnticFrameHandler.class);

    private final Config config;

    public AnticFrameHandler(Config config) {
        this.config = config;
    }
