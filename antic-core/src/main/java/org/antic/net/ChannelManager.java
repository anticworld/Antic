...
public class ChannelManager {
    ...
    protected final AnticIpFilter ipFilter;

    public ChannelManager(Kernel kernel) {
        ipFilter = new AnticIpFilter.Loader()
                .load(new File(kernel.getConfig().configDir(), AnticIpFilter.CONFIG_FILE).toPath());
    }
     ...
     * @return
     */
    public AnticIpFilter getIpFilter() {
        return ipFilter;
    }
