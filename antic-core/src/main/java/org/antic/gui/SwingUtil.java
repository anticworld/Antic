...
import static org.antic.gui.TextContextMenuItem.COPY;
import static org.antic.gui.TextContextMenuItem.CUT;
import static org.antic.gui.TextContextMenuItem.PASTE;
...
public class SwingUtil {
    ...
    public static Unit defaultUnit = ANTIC;
    ...
    /**
     * Formats a Antic value without truncation.
     *
     * @param a
     * @return
     */
     ...
     * @return
     */
    public static String getTransactionDescription(AnticGui gui, Transaction tx) {
        switch (tx.getType()) {
        case COINBASE:
     ...
     * @return
     */
    public static String describeAddress(AnticGui gui, byte[] address) {
     ...
     * @return
     */
    public static Optional<String> getAddressAlias(AnticGui gui, byte[] address) {
     ...
     * @return
     */
    public static Optional<String> getAddressDelegateName(AnticGui gui, byte[] address) {
