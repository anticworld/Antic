...
import org.antic.core.event.WalletLoadingEvent;
...
import org.antic.event.PubSub;
import org.antic.event.PubSubFactory;
import org.antic.exception.LauncherException;
import org.antic.gui.dialog.AddressBookDialog;
import org.antic.gui.dialog.InitializeHdWalletDialog;
import org.antic.gui.dialog.InputDialog;
import org.antic.gui.dialog.SelectDialog;
import org.antic.gui.event.MainFrameStartedEvent;
import org.antic.gui.event.WalletSelectionDialogShownEvent;
import org.antic.gui.model.WalletAccount;
import org.antic.gui.model.WalletDelegate;
import org.antic.gui.model.WalletModel;
import org.antic.gui.model.WalletModel.Status;
import org.antic.message.GuiMessages;
import org.antic.net.Peer;
 ...
 */
public class AnticGui extends Launcher {

    public static final boolean ENABLE_HD_WALLET_BY_DEFAULT = true;

    private static final Logger logger = LoggerFactory.getLogger(AnticGui.class);
    ...
    /**
     * Creates a new Antic GUI instance.
     */
    public AnticGui() {
     ...
     * @param kernel
     */
    public AnticGui(WalletModel model, Kernel kernel) {
        SystemUtil.setLocale(getConfig().uiLocale());
    ...
    protected static void setupLookAndFeel() {
        ...
        System.setProperty("com.apple.mrj.application.apple.menu.about.name", "Antic");
    }

    /**
     * Returns the min version of antic wallet.
     *
     * @return the min version, or null if failed to retrieve
     */
    protected Version getCurrentVersions() {
        try {
            URL url = new URL("http://api.antic.org/version");
