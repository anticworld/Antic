...
import org.antic.util.CircularFixedSizeList;
import org.antic.util.CommandParser;
...
public class ConsoleDialog extends JDialog implements ActionListener {
    ...
    private final transient AnticApiImpl api;
    ...
    public ConsoleDialog(AnticGui gui, JFrame parent) {
        ...
        this.api = new org.antic.api.v2.AnticApiImpl(gui.getKernel());
        for (Method m : AnticApi.class.getMethods()) {
