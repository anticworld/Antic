...
import static org.antic.vm.client.Conversion.amountToWei;
import static org.antic.vm.client.Conversion.weiToAmount;
...
public class AnticPrecompiledContracts extends ConstantinoplePrecompiledContracts {
    ...
    public static class Vote implements PrecompiledContract {
        ...
        public Pair<Boolean, byte[]> execute(PrecompiledContractContext context) {
            ...
            if (track instanceof AnticRepository) {
                AnticRepository anticTrack = (AnticRepository) track;
                AccountState as = anticTrack.getAccountState();
                DelegateState ds = anticTrack.getDelegateState();
