...
/**
 * Represents a Antic-flavored internal transaction.
 */
public class AnticInternalTransaction {
    ...
    public AnticInternalTransaction(byte[] rootTxHash, InternalTransaction it) {
    ...
    public AnticInternalTransaction(byte[] rootTxHash, boolean rejected, int depth, int index, String type, byte[] from, byte[] to,
            long nonce,
    ...
    public static AnticInternalTransaction fromBytes(byte[] bytes) {
        ...
        return new AnticInternalTransaction(rootTxHash, isRejected, depth, index,
                type, from, to, nonce, value, data, gas, gasPrice);
    }

    @Override
    public String toString() {
        return "AnticInternalTransaction{" +
                "rejected=" + rejected +
                ", depth=" + depth +
                ", index=" + index +
                ", type=" + type +
