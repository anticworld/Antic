...
import org.antic.api.AnticApiService;
import org.antic.config.Config;
import org.antic.config.Constants;
import org.antic.consensus.AnticBft;
import org.antic.consensus.AnticSync;
...
import org.antic.db.LeveldbDatabase.LeveldbFactory;
import org.antic.event.KernelBootingEvent;
...
import org.antic.net.PeerClient;
import org.antic.net.PeerServer;
...
public class Kernel {
    ...
    protected AnticApiService api;

    protected Thread consThread;
    protected AnticSync sync;
    protected AnticBft bft;
    ...
    public synchronized void start() {
        ...
        // ====================================
        sync = new AnticSync(this);
        bft = new AnticBft(this);
    ...
    /**
     * Get instance of Antic API server
     *
     * @return API server
     */
    public AnticApiService getApi() {
        return api;
    }
     ...
     * @return
     */
    public AnticBlock createEmptyBlock() {
        ...
        BlockHeader blockHeader = new BlockHeader(
                ...
                Bytes.EMPTY_HASH,
                Bytes.EMPTY_BYTES);
        return new AnticBlock(blockHeader, getConfig().spec().maxBlockGasLimit());
    }
}
