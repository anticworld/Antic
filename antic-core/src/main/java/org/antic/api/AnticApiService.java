...
import org.antic.api.http.HttpChannelInitializer;
 ...
 * Antic API launcher
 */
public class AnticApiService {

    private static final Logger logger = LoggerFactory.getLogger(AnticApiService.class);
    ...
    public AnticApiService(Kernel kernel) {
        this.kernel = kernel;
